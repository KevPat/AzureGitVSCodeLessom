...
import AboutPopupAnimatedText from "./AboutPopupAnimatedText";
            ...
            <div className="author">
              ...
              <div className="short">
                <h3 className="hermtac-font">
                  <span className="hermtac-orange">H<span className="hermtac-blue">ERM</span>T<span className="hermtac-blue">AC</span></span>
                </h3>
                <h3 className="job">
                  <AboutPopupAnimatedText />
                </h3>
              </div>
            </div>
            <div className="list">
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a href="https://goo.gl/maps/1aDUjgXygfAj1Eug6" className="href_location">
                        UT Dallas
                      </a>
                    </span>
                  </div>
